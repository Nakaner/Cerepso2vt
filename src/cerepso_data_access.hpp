...
#include "input/cerepso/nodes_provider.hpp"
#include "input/cerepso/metadata_fields.hpp"
...
public:
    CerepsoDataAccess(VectortileGeneratorConfig& config, std::unique_ptr<input::cerepso::NodesProvider>&& nodes_provider,
